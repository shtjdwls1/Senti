...
<body>
    ...
    <main>
        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                <h5 class="card-title"  id= "title" ><strong><%= dto.get(0).getTitle() %></strong></h5>
                <p class="card-text mb-1" id= "singer"><%= dto.get(0).getSinger() %></p>
                <img src="<%= dto.get(0).getAlbumimg() %>" class="card-img-top shadow-sm p-3 mb-1 bg-body rounded" id="albumimg" alt="...">
                <p><%= dto.get(0).getRelease() %></p>
                <p class="card-text"  id= "genre">장르 : <%= dto.get(0).getGenre() %></p>
